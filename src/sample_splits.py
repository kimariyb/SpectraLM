...
def main() -> None:
    ...
    parser.add_argument("--dataset", default="src/data/NMRexp_spectra_dataset.pkl")
    parser.add_argument("--split-csv", default="src/data/splits/scaffold_split.csv")
    parser.add_argument("--out-dir", default="src/data/subsets/spectralm_500_100")
